...
const Editor = () => {
  ...
  return (
    <div className="py-14 px-2 md:px-60">
      <div className="flex items-center justify-center mb-3 gap-1">
        <Link
          href={"/"}
          className="bg-blue-500 rounded px-3 py-2 text-sm text-white font-bold outline-none transition-all hover:bg-blue-600"
        >
          Inti Kode
        </Link>
        <Link
          href={"/dashboard"}
          className="bg-gray-500 rounded px-3 py-2 text-sm text-white font-bold outline-none transition-all hover:bg-gray-600"
        >
          Kembali
        </Link>
      </div>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="mb-3">
          ...
          {formik.errors.title2 && formik.touched.title2 && (
            <p className="text-red-500 text-xs mt-1 ">{formik.errors.title2}</p>
          )}
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className={`${
              loading ? "opacity-80 cursor-not-allowed" : "hover:bg-gray-600"
            } text-sm md:text-base mt-3 bg-gray-500 rounded px-3 py-2 text-white font-bold outline-none transition-all `}
          >
            Clear
          </button>
        </div>
